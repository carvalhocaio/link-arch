...
export const metadata: Metadata = {
	...
	description: "The terms that govern your use of Link Arch.",
};
		...
		<LegalPageLayout title="Terms of Service" lastUpdated="March 19, 2026">
			<section className="space-y-3">
				...
				<p className="text-xs leading-relaxed text-muted-foreground">
					By accessing or using Link Arch (&quot;the Service&quot;), you agree to be bound by these
			...
			<section className="space-y-3">
				<h2 className="text-base font-semibold">3. Description of Service</h2>
				<p className="text-xs leading-relaxed text-muted-foreground">
					Link Arch provides a URL shortening service that allows users to create shortened versions
					of long URLs. The Service may also provide analytics and management features for shortened
					URLs.
				</p>
			</section>
			<section className="space-y-3">
			...
			<section className="space-y-3">
				<h2 className="text-base font-semibold">5. User Content and Links</h2>
				<p className="text-xs leading-relaxed text-muted-foreground">
					You are responsible for the destination URLs and content you share through shortened
					links. You represent that you have the right to share such links and that they comply with
			...
			<section className="space-y-3">
				...
				<p className="text-xs leading-relaxed text-muted-foreground">
					The Service and its original content, features, and functionality are owned by Link Arch
					and are protected by copyright, trademark, and other intellectual property laws. You
					retain ownership of the URLs you shorten through the Service.
				</p>
			</section>
			<section className="space-y-3">
				<h2 className="text-base font-semibold">7. Availability and Changes</h2>
				<p className="text-xs leading-relaxed text-muted-foreground">
					We may modify, suspend, or discontinue any part of the Service at any time, with or
					without notice. We are not liable for any modification, interruption, or discontinuance of
					the Service.
				</p>
			</section>
			<section className="space-y-3">
				<h2 className="text-base font-semibold">8. Suspension and Termination</h2>
				<p className="text-xs leading-relaxed text-muted-foreground">
					We may terminate or suspend your account and access to the Service immediately, without
					prior notice, for any reason, including if you breach these Terms. Upon termination, your
					right to use the Service will cease immediately and your shortened URLs may be
					deactivated.
				</p>
			</section>
			<section className="space-y-3">
			...
			<section className="space-y-3">
				...
				<p className="text-xs leading-relaxed text-muted-foreground">
					...
					profits, data, or other intangible losses, resulting from your use of or inability to use
					the Service.
				</p>
			</section>
			<section className="space-y-3">
				...
				<p className="text-xs leading-relaxed text-muted-foreground">
					...
					liabilities, damages, and expenses arising from your use of the Service, your links, or
			...
			<section className="space-y-3">
				...
				<p className="text-xs leading-relaxed text-muted-foreground">
					These Terms are governed by applicable laws in the jurisdiction of the Service operator,
			...
			<section className="space-y-3">
				...
				<p className="text-xs leading-relaxed text-muted-foreground">
					...
					significant changes by posting the updated Terms on the Service. Your continued use of the
